...
var DOMPLATE_UTIL = require("domplate/util");
...
*/
	...
	var renderSupervisor = new RENDERER.Supervisor();
	renderSupervisor.setMessageWrapper({
			id: "github.com/insight/insight.renderers.default/",
	...
	function logMessageToInsightNode (message) {
		try {

			renderSupervisor.appendMessageToNode(panelNode[0], message);
...
*/
	...
	return context.registerApi("console.clear", function (args) {
		...
		return context.registerApi("console.log.firephp", function (args) {

try {
console.log("LOG FirePHP MESSAGE!!!", args);

				logMessageToInsightNode({
						meta: args[0] || {},
						og: args[1]
				});
